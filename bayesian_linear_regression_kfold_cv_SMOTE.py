...
# Perform tuning
best_alpha, best_beta = tune_hyperparameters(X_scaled_SMOTE, y_SMOTE, alpha_values, beta_values)
print(f"Best Alpha: {best_alpha}, Best Beta: {best_beta}")

# Train the final model with the best hyperparameters
mu_opt, Sigma_opt = bayesian_linear_regression(X_scaled_SMOTE, y_SMOTE, best_alpha, best_beta)
